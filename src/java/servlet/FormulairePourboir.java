 ...
 * @author ITU
 */
public class FormulairePourboir extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Vector listserveur=serveur.selectV(connex.getConnexion());
        Serveur[] listserv=new Serveur[listserveur.size()];
        listserveur.copyInto(listserv);
       
         request.setAttribute( "serveur", listserv );
           String page="Pourboir.jsp";
