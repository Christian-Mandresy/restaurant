 ...
 * @author ITU
 */
public class ResteIngredient extends HttpServlet {
...
"    ( sum(ei.quantite)*(select avg(prix) from EnregistrementIngredient where ingredient=ei.ingredient and dateenregistrement )/1000) prix\n" +
"from \n" +
