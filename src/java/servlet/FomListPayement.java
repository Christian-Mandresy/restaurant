 ...
 * @author ITU
 */
public class FomListPayement extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Vector listtype=type.selectV(connex.getConnexion());
            TypePaiement[] listtyp=new TypePaiement[listtype.size()];
            listtype.copyInto(listtyp);
            
            request.setAttribute( "type", listtyp );
            
            connex.getConnexion().close();
            String page="datePayement.jsp";
